...
// ─── Validation Schema (mirrors backend Joi rules) ──
...
export default function NewPropertyPage() {
 ...
 const {
  ...
  if (authLoading || !isAuthenticated) return null // brief flash prevention
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 flex-1 w-full">
        <h1 className="text-2xl font-bold text-gray-800 mb-1">List Your Property</h1>
        <p className="text-gray-500 mb-6">Fill in the details to create a new listing</p>
